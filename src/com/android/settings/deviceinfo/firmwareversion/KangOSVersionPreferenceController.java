...
public class KangOSVersionPreferenceController extends BasePreferenceController {
    ...
    private static final String TAG = "kangosVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_KANGOS_VERSION_PROP = "ro.kangos.build.version";
    ...
    public KangOSVersionPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public void copy() {
        Sliceable.setCopyContent(mContext, getSummary(),
                mContext.getText(R.string.kangos_version));
    }
}
